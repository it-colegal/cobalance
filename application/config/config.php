...
$config['base_url'] = " https://coba.piksanesia.com";
// $config['member_assets']='http://localhost/arisan/member/assets/bukti/';
...
$config['sess_cookie_name'] = 'colegal_session';
